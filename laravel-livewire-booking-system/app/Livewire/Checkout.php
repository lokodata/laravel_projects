...
class Checkout extends Component
{
    ...
    {
        $this->form->date = $this->availability()->firstAavailableDate()?->date?->toDateString() ?? now()->toDateString();
    }
    ...
    {
        $appointment = Appointment::make($this->form->only('name', 'email') + [
    ...
    public function slots()
    {
        ...
        })?->slots; // Add a semicolon at the end of this line
    }
    ...
    {
        return (new ServiceSlotAvailability($this->employee ? collect([$this->employee]) : Employee::get(), $this->service))
        ->forPeriod(
            now()->startOfDay(),
