...
<div class="mt-6 ">
    @foreach ($chirps as $chirp)
        <div class="flex p-6 mt-4 space-x-2 bg-white rounded-lg shadow-sm" wire:key="{{ $chirp->id }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600 -scale-x-100" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                stroke-width="2">
